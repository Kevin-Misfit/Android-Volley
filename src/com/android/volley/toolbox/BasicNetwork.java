        ...
        while (true) {
            ...
            try {
                ...
                if (statusCode == HttpStatus.SC_NOT_MODIFIED) {
                    ...
                    if (entry == null) {
                        return new NetworkResponse(HttpStatus.SC_NOT_MODIFIED, statusLine.getReasonPhrase(), null,
                ...
                return new NetworkResponse(statusCode, statusLine.getReasonPhrase(), responseContents, responseHeaders, false,
                        SystemClock.elapsedRealtime() - requestStart);
